...
const mockUsers = [
  { id: 1, email: "admin@example.com", password: "admin123", role: "admin", name: "Admin User", mfaEnabled: true },
  { id: 2, email: "instructor@example.com", password: "instructor123", name: "Instructor User", role: "instructor", mfaEnabled: false },
  { id: 3, email: "learner@example.com", password: "learner123", name: "Learner User", role: "learner", mfaEnabled: false },
];
    ...
    <PageTransition>
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-4">
          <Card className="w-full max-w-md shadow-lg card-3d">
              ...
              {!showMfa ? (
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    />
                    <Button type="submit" className="w-full button-3d">Sign In</Button>
                  </form>
                </Form>
              ) : (
                <div className="space-y-4">
                  ...
                  <Button onClick={handleMfaSubmit} className="w-full button-3d">Verify</Button>
